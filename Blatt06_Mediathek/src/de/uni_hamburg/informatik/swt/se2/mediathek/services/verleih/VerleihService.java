...
public interface VerleihService extends ObservableService
{
    ...
    /**
     * Legt eine Vormerkung für die angegebenen Medien an.
     * @param medien Die vorzumerkenden Medien.
     * @param kunde Der Kunde, für den die Vormerkung angelegt wird
     * 
     ...
     * @require kunde != null
     * 
     * @ensure istVorgemerkt(medium, kunde)
     */
    void merkeVor(List<Medium> medien, Kunde kunde);
    
    /**
     * Storniert die Vormerkung eines Kunden.
     * @param medium Das Medium, für das die Vormerkung zu stornieren ist.
     * @param kunde Der Kunde, für den die Vormerkung zu stornieren ist.
     * 
     ...
     * @require medium != null
     * 
     * @ensure istVormerkenMoeglich(medium, kunde)
     */
    void storniereVormerkung(Medium medium, Kunde kunde);
    
    /**
     * Prüft, ob das Vormerken des Mediums für den angegebenen Kunden möglich ist.
     * @param medium Das vorzumerkende Medium.
     * @param kunde Der Kunde, für den das Vormerken zu prüfen ist.
     ...
     * @param medium Das Medium, für das die Vormerkkarte zurückgegeben werden soll.
    ...
    /**
     * Gibt die Liste aller Vormerkkarten zurück.
     * @return Liste aller Vormerkkarten.
     */
    List<Vormerkkarte> getVormerkkarten();
    
    /**
     * Gibt die Vormerkkarten für einen Kunden zurück.
     * @param kunde Der Kunde, für den die Vormerkkarten zu suchen sind.
     * @return Eine Liste mit allen Vormerkkarten für den Kunden. Leere Liste, wenn der Kunde nichts vorgemerkt hat.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt Auskunft darüber, ob ein Medium ausgeliehen ist.
     * @param medium Das zu überprüfende Medium.
     * @return true, wenn Vormerkungen für das Medium bestehen, sonst false
     * 
     * @require mediumImBestand(medium)
     * 
     * @ensure result != null
