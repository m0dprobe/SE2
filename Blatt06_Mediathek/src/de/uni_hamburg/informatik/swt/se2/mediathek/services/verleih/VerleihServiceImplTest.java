...
public class VerleihServiceImplTest
{
    ...
    @Test
    public void testNachInitialisierungIstNichtsVorgemerkt()
    {
    ...
    public void testeVormerkenUndStornieren()
    {
    	...
    	assertTrue(_service.istVormerkenMoeglich(nichtVorgemerkteMedien, _vormerkkunde));
    	assertFalse(_service.istVormerkenMoeglich(vorgemerkteMedien, _vormerkkunde));
    	
    	for(Medium m : vorgemerkteMedien)
    	{
    		_service.storniereVormerkung(m, _vormerkkunde);
    	}
    	
    	assertFalse(_service.istVorgemerkt(vorgemerkteMedien.get(0)));
    	assertFalse(_service.istVorgemerkt(vorgemerkteMedien.get(1)));
    	
    	assertTrue(_service.istVormerkenMoeglich(vorgemerkteMedien, _vormerkkunde));
    }
