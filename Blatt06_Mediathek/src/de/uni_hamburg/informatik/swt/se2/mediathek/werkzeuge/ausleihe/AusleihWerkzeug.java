...
public class AusleihWerkzeug
{
    ...
    private boolean istAusleihenMoeglich()
    {
        ...
        boolean ausleiheMoeglichVorgemerkt = true;
        
        for(Medium m : medien)
        {
        	if(_verleihService.istVorgemerkt(m))
        	{
        		ausleiheMoeglichVorgemerkt = _verleihService.getVormerkkarteFuer(m).getVormerker(1).equals(kunde);
        	}
        }
        
        
        return ausleiheMoeglich && ausleiheMoeglichVorgemerkt;
    }
